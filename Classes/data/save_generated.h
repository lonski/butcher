...
struct SaveData : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<InventoryData>> *inventory() const { return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<InventoryData>> *>(10); }
  const CraftbookData *craftbook() const { return GetPointer<const CraftbookData *>(12); }
};
...
struct SaveDataBuilder {
  ...
  void add_inventory(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<InventoryData>>> inventory) { fbb_.AddOffset(10, inventory); }
  void add_craftbook(flatbuffers::Offset<CraftbookData> craftbook) { fbb_.AddOffset(12, craftbook); }
  SaveDataBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
  flatbuffers::Offset<SaveData> Finish() { return flatbuffers::Offset<SaveData>(fbb_.EndTable(start_, 5)); }
};

inline flatbuffers::Offset<SaveData> CreateSaveData(flatbuffers::FlatBufferBuilder &_fbb, int32_t exp, int32_t level, int32_t dungeon_level, flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<InventoryData>>> inventory, flatbuffers::Offset<CraftbookData> craftbook) {
